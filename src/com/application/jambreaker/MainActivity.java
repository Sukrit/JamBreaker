...
public class MainActivity extends FragmentActivity {
	...
	String regid;
	private static final LatLng SIMS_DORADO = new LatLng(1.315526, 103.890842);
	...
	private void showDialog() {
		...
		.setMessage(
				"Are you stuck in a JAM at this location?")
								...
								protected Object doInBackground(
									...
									try {
										...
										data.putString("action",
												"com.application.jambreaker.ECHO_NOW");
	...
	private void showDialog(Location myLocation) {
	...
	private void showCurrentLocation(boolean needDialog) {
		Log.i(TAG, "Show location");

		Location myLocation = null;
		myLocation = map.getMyLocation();

		if(myLocation == null && needDialog==true) {
			showDialog();
		}
		else {
